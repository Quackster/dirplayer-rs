 ...
 * Port of Rust SpriteForeColorKeyframes struct.
 */
public class SpriteForeColorKeyframes implements KeyframeTrack<ColorKeyframe> {
    public int channel;
    public List<ColorKeyframe> keyframes;
    public TweenInfo tweenInfo;
    public List<int[]> intervals; // Each int[] is {startFrame, endFrame}

    public SpriteForeColorKeyframes(int channelIndex, TweenInfo tweenInfo) {
    ...
    /**
     * Check if this track has valid tween info for forecolor tweening.
     */
    public boolean isForecolorTweened() {
        return tweenInfo != null && tweenInfo.isForecolorTweened();
    }
}
